...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="{{ route('authors.store') }}" method="POST" id="categoryform" name="categoryform" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="pio" id="pio" class="form-control" placeholder="Bio" value="{{ old('pio') }}">
