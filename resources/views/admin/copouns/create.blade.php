...
<div class="content-wrapper">
    ...
    <section class="content-header">					
        <div class="container-fluid my-2"> 
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Copoun Code</h1>
                </div>
                <div class="col-sm-6 text-right"> 
                     <a href="{{ route('copoun.index') }}" class="btn btn-primary">Back</a>
    ...
    <section class="content">
        <!-- Default box -->
        <form action="{{ route('copoun.store') }}" method="POST" id="" name="copounform" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                          ...
                          <div class="col-md-6">
                            <div class="mb-3">
                                <label for="name">Maxs Uses</label>
                                <input type="number" name="maxs_uses" id="maxs_uses" class="form-control" placeholder=" Max Uses">
                                 @error('maxs_uses') <p class="text-danger">{{ $message }}</p> @enderror	
                                <p></p>
                            </div>
                        </div>
                        <div class="col-md-6">
    <div class="mb-3">
        ...
        <input type="number" name="maxs_uses_users" id="maxs_uses_users" class="form-control" placeholder="Max Uses Per User">	
         @error('maxs_uses_users') <p class="text-danger">{{ $message }}</p> @enderror
    </div>
</div>
...
<div class="col-md-6">
    <div class="mb-3">
        ...
        <input type="text" name="min_amount" id="min_amount" class="form-control" placeholder="Minimum Amount">
         @error('min_amount') <p class="text-danger">{{ $message }}</p> @enderror
    </div>
</div>
...
<div class="col-md-6">
    <div class="mb-3">
        ...
        <input type="datetime-local" name="expires_at" id="expires_at" class="form-control">
         @error('expires_at') <p class="text-danger">{{ $message }}</p> @enderror
    </div>
</div>
